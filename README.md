...
- [x] Mention two parts of Express that you learned about this week.
    ...
    Server routing, and the request/response cycle.

- [x] Describe Middleware?

    Middleware is a function executed in the middle of an incoming request that either returns or passes the baton to the next middleware in the cycle until it is completed.
...
- [x] What can the API return to help clients know if a request was successful?
    ...
    Returns HTTP status codes with a message of either success or error.
